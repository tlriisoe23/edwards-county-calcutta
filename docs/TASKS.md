...
<!-- GENERATED: task JSON is canonical. Move completed records to tasks/archive; never duplicate IDs. -->

Statuses are queue positions, not proof of tests, merge, or deployment. Open only the selected task and its spec.

| ID | Title | Queue state | Risk / mode |
|---|---|---|---|
| [T-0001](../tasks/active/T-0001.json) | Adopt framework governance: records, backlog, release record, archives | in_progress | normal / curated |
...
Archived records: 0. See [archive routing](../tasks/archive/README.md).
